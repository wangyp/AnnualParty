   ...
   public class AnnualPartySqlHelper
    {
       ...
       /// <returns></returns>
       public bool UpdateAward(string number, int award,int awardIndex)
       {
           string sql = "update Employee set Award=@award,AwardTime=getdate(),AwardIndex=@aindex where EmployeeNumber=@number";
           return SqlHelper.ExecuteNonQuery(conn, System.Data.CommandType.Text, sql, 
               new SqlParameter("@award", award), 
               new SqlParameter("@number", number),
               new SqlParameter("@aindex",awardIndex)) > 0;
       }
       /// <summary>
       /// 清空中奖结果
       /// </summary>
       ...
       {
           string sql = "update Employee set Award=-1,AwardTime=null";
           return SqlHelper.ExecuteNonQuery(conn, System.Data.CommandType.Text, sql) > 0;
       }
